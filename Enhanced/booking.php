...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif (!preg_match("/^\+?[0-9]{1,3}?\s?\(?\)?[0-9]{3}\s?-?[0-9]{3}\s?-?[0-9]{4}$/", $phone)) {
    ...
    if (empty($checkin)) {
        $error_checkin = "Checkin Date is required";
    } else {
        $error_checkin = "";
    }
    ...
    if (empty($checkout)) {
        $error_checkout = "Checkin Date is required";
    } else {
        $error_checkout = "";
    }

    if (empty($adult)) {
        $error_adult = "Adult No is required";
    ...
    if (empty($children)) {
        $error_children = "Children No is required";
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="form">
                    <div class="user_details">
                        ...
                        <div class="input_box">
                            ...
                            <input type="date" name="checkin" id="cin">
                        ...
                        <div class="input_box">
                            ...
                            <input type="date" name="checkout" id="cout">
